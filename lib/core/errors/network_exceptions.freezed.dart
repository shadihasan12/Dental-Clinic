...
abstract class _$$CanceledByUserImplCopyWith<$Res> {
  factory _$$CanceledByUserImplCopyWith(
    _$CanceledByUserImpl value,
...
class __$$CanceledByUserImplCopyWithImpl<$Res>
  ...
  __$$CanceledByUserImplCopyWithImpl(
    _$CanceledByUserImpl _value,
    $Res Function(_$CanceledByUserImpl) _then,
  ) : super(_value, _then);
...
class _$TooManyRequestsImpl implements TooManyRequests {
  ...
  @override
  String toString() {
    return 'NetworkExceptions.tooManyRequests(message: $message)';
  }
...
abstract class TooManyRequests implements NetworkExceptions {
  const factory TooManyRequests(final String message) = _$TooManyRequestsImpl;
