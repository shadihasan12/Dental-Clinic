...
class _$NotificationEntityImpl implements _NotificationEntity {
  ...
  @override
  String toString() {
    return 'NotificationEntity(id: $id, title: $title, content: $content, type: $type, timestamp: $timestamp, isRead: $isRead)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, content, type, timestamp, isRead);
