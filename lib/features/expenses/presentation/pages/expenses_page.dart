      ...
      body: BlocListener<ExpenseBloc, ExpenseState>(
        ...
        child: BlocBuilder<ExpenseBloc, ExpenseState>(
          builder: (context, state) {
            ...
            // Full-bleed gives up the 8pt of top padding RootPage applies to
            // an unconverted tab; kept here so converting the tab does not
            // also nudge the header up. The bottom is left open for the pill
            // to float over.
            return Padding(
              padding: const EdgeInsets.only(top: 8),
              child: _buildMobile(context, state),
            );
          },
        ),
      ),
...
class _DesktopExpenseRowState extends State<_DesktopExpenseRow> {
  ...
  String _formatDate(String raw) {
    ...
    return AppDate.medium(context, d);
  }
